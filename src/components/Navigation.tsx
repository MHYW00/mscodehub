          ...
          {navItems.map((item, index) => (
            ...
            >
              <Link
                href={item.href}
                onClick={closeMobileMenu}
                className={`flex items-center space-x-4 px-6 py-4 text-lg font-medium transition-all duration-200 hover:bg-gray-800/50 hover:border-r-4 hover:border-blue-500 ${
                  pathname === item.href
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <motion.a
                  ...
                  variants={buttonVariants}
                  whileTap="tap"
                  className="flex items-center space-x-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors min-w-[48px] min-h-[48px]"
