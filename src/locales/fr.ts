export const fr = {
  ...
  home: {
    company: {
      founder: 'Fondateurs',
      tagline: 'Votre partenaire technologique de confiance pour la transformation numérique',
      description: 'Nous offrons des solutions de niveau entreprise avec des technologies web modernes. Avec notre équipe spécialisée dans les technologies React, Next.js, TypeScript et Node.js, nous développons des logiciels adaptés aux besoins numériques de votre entreprise.'
    },
    stats: {
    ...
    services: {
      subtitle: 'Nous offrons des solutions personnalisées pour les besoins de votre entreprise'
    },
    hero: {
      contact: 'Contact'
    }
  ...
  services: {
    ...
    web: {
      ...
      description: 'Nous développons des applications web modernes et responsives. Nous fournissons des solutions rapides et fiables en utilisant les technologies React, Next.js et TypeScript.'
    },
    ecommerce: {
      title: 'Solutions E-commerce',
      description: 'Nous créons des plateformes e-commerce complètes. Nous fournissons des solutions entièrement intégrées avec des systèmes de paiement, gestion des stocks et outils d\'analyse.'
    },
    api: {
      title: 'Développement API',
      description: 'Nous développons des APIs RESTful et GraphQL. Nous intégrons vos systèmes avec des solutions backend évolutives et sécurisées.'
    },
    consulting: {
      title: 'Conseil Technologique',
      description: 'Nous vous guidons à travers votre processus de transformation numérique. Nous fournissons un support expert dans la sélection de technologies, la conception architecturale et les processus de développement.'
    }
  },
  contact: {
    methods: {
      whatsapp: {
        title: 'WhatsApp',
        description: 'Pour une communication rapide'
      },
      email: {
        title: 'Email',
      ...
      linkedin: {
        title: 'LinkedIn',
        description: 'Notre réseau professionnel'
      },
      phone: {
        title: 'Téléphone',
      ...
      hours: {
        ...
        description: 'Heures de bureau en semaine'
      }
    },
    page: {
      cta: {
        title: 'Discutons de Votre Projet',
        subtitle: 'Nous sommes avec vous dans votre parcours de transformation numérique'
      }
    },
    stats: {
      response: 'Dans les 24 Heures',
      secure: '100% Sécurisé',
    ...
    form: {
      detailedTitle: 'Détails du Projet',
      detailedSubtitle: 'Fournissez des informations détaillées sur votre projet',
      name: 'Nom Complet',
      placeholder: {
        ...
        budget: 'Sélectionnez votre fourchette de budget',
        message: 'Écrivez les détails de votre projet'
      },
      email: 'Email',
      company: 'Entreprise',
    ...
    location: {
      title: 'Localisation',
      subtitle: 'Service à Distance',
      city: 'Turquie et Monde',
      description: 'Nous servons des clients dans le monde entier avec notre modèle de travail 100% à distance'
    },
    services: {
      local: {
        title: 'Réunions en Ligne',
        description: 'Discussions de projet par visioconférence'
      },
      remote: {
        title: 'Développement à Distance',
        description: 'Développement de code entièrement à distance et support'
      },
      flexible: {
        title: 'Accès Global',
        description: 'Service accessible 24h/7j dans le monde entier'
      }
    }
  },
  projects: {
    title: 'Nos Projets',
    subtitle: 'Nos projets réussis',
    ecommerce: {
      title: 'Plateforme E-commerce',
      description: 'Augmentez vos ventes avec une solution e-commerce moderne'
    },
    dashboard: {
      title: 'Panneau de Gestion',
      description: 'Gérez votre entreprise depuis un seul écran'
    },
    viewAll: 'Voir Tous les Projets',
    page: {
      title: 'Nos Projets',
      subtitle: 'Nos projets et solutions réussis',
      customProject: 'Vous voulez un Projet Personnalisé ?',
      customDescription: 'Nous développons des solutions personnalisées pour vos besoins. Contactez-nous pour discuter de votre projet.',
      getProjectQuote: 'Obtenir un Devis de Projet'
    },
    hero: {
      contact: 'Contact'
    },
    labels: {
      projectQuote: 'Devis de Projet',
    ...
    testimonials: {
      ...
      project: 'Projet',
      ugur: {
        text: 'Travailler avec MSCodeHub a été une excellente expérience. Notre site e-commerce s\'est avéré bien meilleur que prévu.',
        project: 'Plateforme E-commerce'
      },
      elif: {
        text: 'Approche professionnelle et code de qualité. Notre projet de tableau de bord a été développé exactement selon nos besoins.',
        project: 'Panneau de Gestion'
      },
      mehmet: {
        text: 'Notre application mobile a été très réussie. Merci à l\'équipe MSCodeHub.',
  ...
  blog: {
    hero: {
      title: 'Blog',
      subtitle: 'Contenu le plus récent du monde de la technologie'
    },
    react: {
      title: 'Développement Web Moderne avec React',
      description: 'Découvrez les dernières fonctionnalités de React',
      date: '15 Mars 2024'
    },
    web3: {
      title: 'Technologies Web3 et Blockchain',
      description: 'Découvrez l\'internet du futur aujourd\'hui',
      date: '10 Mars 2024'
    },
    rust: {
      title: 'Programmation Système avec Rust',
      description: 'Développez des applications axées sur la performance',
      date: '5 Mars 2024'
    },
    date: {
      react: '15 Mars 2024',
    ...
    page: {
      ...
      title: 'Blog',
      subtitle: 'Contenu le plus récent et opinions d\'experts du monde de la technologie',
      searchPlaceholder: 'Rechercher dans les articles...',
      articles: 'Articles',
      categories: 'Catégories',
      weeklyUpdates: 'Mises à Jour Hebdomadaires',
      categoriesSubtitle: 'Découvrez les sujets qui vous intéressent',
      articlesCount: 'articles',
      featuredTitle: 'Articles en Vedette',
      featuredSubtitle: 'Contenu le plus populaire et actuel',
      readMore: 'Lire Plus',
      allPosts: 'Tous les Articles',
      searchResultsFound: 'résultats de recherche trouvés',
      newsletter: {
        title: 'Newsletter Hebdomadaire',
        subtitle: 'Restez informé de nos nouveaux articles',
        placeholder: 'Votre adresse email',
        subscribe: 'S\'abonner'
      },
      newsletterDisclaimer: 'Votre adresse email est utilisée uniquement pour la newsletter.'
    },
    categories: {
      all: {
        name: 'Tous',
      ...
      react: {
        name: 'React',
        description: 'React et frontend moderne'
      },
      typescript: {
        name: 'TypeScript',
        description: 'Conseils TypeScript'
      },
      css: {
        name: 'CSS',
        description: 'Style et design'
      },
      backend: {
        name: 'Backend',
  ...
  about: {
    hero: {
      ...
      description: 'Votre partenaire technologique de confiance dans votre parcours de transformation numérique'
    },
    company: {
      story: 'Notre Histoire',
      description: 'En tant que MSCodeHub, nous dirigeons la transformation numérique des entreprises avec des technologies modernes. Avec notre équipe expérimentée et notre approche innovante, nous menons chaque projet au succès.'
    },
    ceo: {
      title: 'Fondateur et PDG',
      name: 'Mete Han Yıldırım',
      description: 'Développeur full-stack et leader technologique',
      bio1: 'A 8+ années d\'expérience en développement logiciel, expert en technologies web modernes.',
      bio2: 'Connaissance approfondie des technologies React, Next.js, TypeScript et Node.js.',
      bio3: 'A dirigé des projets de niveau entreprise et signé de nombreux projets réussis.'
    },
    skills: {
    ...
    mission: {
      title: 'Notre Mission',
      description: 'Être pionnier de la transformation numérique des entreprises et créer de la valeur grâce à la technologie.'
    },
    quality: {
      title: 'Qualité',
      description: 'Nous appliquons les plus hauts standards de qualité dans chaque projet.'
    },
    improvement: {
      title: 'Amélioration Continue',
      description: 'Nous suivons les nouvelles technologies et nous améliorons continuellement.'
    },
    delivery: {
      title: 'Livraison Ponctuelle',
      description: 'Nous livrons vos projets dans les délais spécifiés.'
    },
    tech: {
      title: 'Technologies Modernes',
      description: 'Nous produisons des solutions prêtes pour l\'avenir avec les dernières technologies.'
    },
    cta: {
      title: 'Travaillez avec Nous',
      description: 'Commençons aujourd\'hui pour donner vie à votre projet.',
      button: 'Nous Contacter'
    }
  },
  cta: {
    title: 'Donnons Vie à Votre Projet',
    description: 'Nous sommes avec vous dans votre parcours de transformation numérique. Contactez-nous pour une consultation gratuite.',
    consultation: 'Consultation Gratuite',
    portfolio: 'Voir Notre Portfolio'
  },
  footer: {
    description: 'Nous offrons des solutions de niveau entreprise avec des technologies web modernes.',
  ...
  legal: {
    kvkk: {
      title: 'Texte d\'Information RGPD',
      subtitle: 'Informations sous le Règlement Général sur la Protection des Données',
      ...
      sections: {
        ...
        dataTypes: {
          ...
          identity: {
            title: '2.1 Données d\'Identité',
            items: [
              'Nom, prénom',
              'Date de naissance (si nécessaire)',
              'Numéro d\'identité (lors de la signature de contrat)'
            ]
          },
          contact: {
            title: '2.2 Données de Contact',
            items: [
              'Adresse e-mail',
              'Numéro de téléphone',
              'Informations d\'adresse',
              'Site web/comptes de réseaux sociaux'
            ]
          },
          transaction: { title: '2.3 Données de Transaction Client', items: ['Détails de demande de projet', 'Exigences techniques', 'Informations budgétaires', 'Historique de communication'] },
          technical: { title: '2.4 Données Techniques', items: ['Adresse IP', 'Informations du navigateur', 'Système d\'exploitation', 'Données de cookies', 'Statistiques d\'utilisation du site'] }
        },
        purposes: {
          title: '3. Finalités du Traitement des Données Personnelles',
          business: { title: 'Processus Métier', items: ['Évaluer les demandes de service', 'Préparer les propositions de projet', 'Gestion des contrats', 'Processus de développement de projet'] },
          communication: { title: 'Communication', items: ['Fournir un support client', 'Faire des annonces', 'Obtenir des commentaires', 'Activités marketing'] },
          legal: { title: 'Obligations Légales', items: ['En raison de la législation fiscale', 'Tenue de livres commerciaux', 'Obligations d\'archivage', 'Processus d\'audit'] },
    ...
    terms: {
      ...
      subtitle: 'Conditions d\'utilisation des services MSCodeHub',
    ...
    privacy: {
      ...
      subtitle: 'Informations sur la protection et le traitement de vos données personnelles',
      lastUpdated: 'Dernière Mise à Jour',
      backHome: 'Retour à l\'Accueil',
      sections: {
        intro: {
  ...
  seo: {
    home: {
      title: 'MSCodeHub - Développement Web & Solutions Numériques',
      description: 'Développement web professionnel avec React, Next.js, TypeScript. E-commerce, API et solutions d\'entreprise par MSCodeHub.',
      keywords: 'développement web, react, nextjs, typescript, ecommerce, développement API, MSCodeHub'
    },
    projects: {
      title: 'Nos Projets - Portfolio MSCodeHub & Projets Web Réussis',
      description: 'Découvrez les applications web, sites e-commerce et solutions d\'entreprise développés par MSCodeHub.',
      keywords: 'projets web, ecommerce, tableau de bord, application mobile, portfolio'
    },
    blog: {
      title: 'Blog - Développement Web et Mises à Jour Technologiques',
      description: 'Derniers articles et guides sur React, TypeScript, Next.js et les technologies web modernes.',
      keywords: 'blog développement web, guides react, typescript, articles technologiques'
    },
    about: {
      title: 'À Propos - Équipe MSCodeHub & Notre Mission',
      description: 'Découvrez qui nous sommes chez MSCodeHub, notre mission et notre expertise en développement web.',
      keywords: 'MSCodeHub à propos, équipe développement web, experts logiciels'
    },
    contact: {
      title: 'Contact - Démarrez Votre Projet Web avec MSCodeHub',
      description: 'Contactez MSCodeHub pour votre site web ou application. Consultation gratuite et devis de projet.',
      keywords: 'contact développement web, devis projet, prix site web'
    }
  }
} 